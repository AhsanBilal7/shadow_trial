...
parser.add_argument('--input_dir', default='/home/ahsan/ahsan_work/ShadowFormer/ISTD_Dataset/test',
    type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./results/',
    type=str, help='Directory for results')
parser.add_argument('--weights', default='./log/ShadowFormer_istd/models/model_best.pth',type=str, help='Path to weights')
# parser.add_argument('--weights', default='./log/ShadowFormer_istd/models/model_best.pth',type=str, help='Path to weights')
